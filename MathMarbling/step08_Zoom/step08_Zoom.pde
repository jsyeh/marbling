...
void setup(){
  size(512,512); //如果這裡寫P3D,則畫出來的線會有線段出錯。所以zoom就使用數學公式來完成
...
String [] functionText={"Ink Drop", "Ink Drop Simple", "Tine Line Pattern", "Wavy Pattern", "Circular Tine Line Pattern", "Vortex Pattern", "Zoom"};
int function=0; //0: Ink Drop, 1: Ink Drop Simple, 2: Tine Line Pattern, 3: Wavy Pattern, 4: Circular Tine Line Pattern, 5: Vortex Pattern, 6: Zoom
...
boolean bZoom=false;
float zoomX=0, zoomY=0, zoomX2, zoomY2, zoomScale=1;
